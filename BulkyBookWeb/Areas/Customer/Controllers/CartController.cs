...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "Order Placed! - BulkyBook.", $"<div><p>Your Order has been Placed Successfully!</p><p>Order number:{orderHeader.Id}</p></div>");
